...
LOCAL_DATA <- 'data.txt' # Where is local data saved? Or, where should it be saved after querying GEO?
...
# The samples to withhold for testing
# Redundant nested vectors here are just used to mark the true class of each sample
